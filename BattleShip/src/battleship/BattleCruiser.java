...
{
    public static String shipClass = "Battle Cruiser";

    public BattleCruiser(int x, int y, boolean vertical, String shipClass) {
        length = 5;
        this.x = x;
        this.y = y;
    ...
    public static BattleCruiser getFromUser() 
    {
        ...
        return new BattleCruiser(x, y, vertical, shipClass);
